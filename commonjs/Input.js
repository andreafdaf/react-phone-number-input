...
var Input = function (_Component) {
	...
	function Input(props) {
		...
		var _this$props = _this.props,
		    ...
		    showCountryPrefixes = _this$props.showCountryPrefixes;
		...
		try {
			for (var _iterator2 = (0, _getIterator3.default)(countries), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
				...
				var label = dictionary[country_code] || default_dictionary[country_code];
				...
				if (!using_custom_country_names && showCountryPrefixes) {
					var prefix = '(+' + (0, _libphonenumberJs.getPhoneCode)(country_code) + ')';
...
Input.propTypes = {
	...
	showCountryPrefixes: _propTypes2.default.bool
};
Input.defaultProps = {
	// Is enabled
	disabled: false,
